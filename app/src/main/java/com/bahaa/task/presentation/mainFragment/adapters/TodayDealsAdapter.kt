...
import com.bahaa.task.databinding.TodayDealItemBinding
import com.bahaa.task.domain.models.remoteModels.Coupon

class TodayDealsAdapter:
ListAdapter<Coupon, TodayDealsAdapter.ItemViewHolder>(CouponDealDiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        return ItemViewHolder(TodayDealItemBinding.inflate(inflater, parent, false))
    }
    ...
    class ItemViewHolder(private val itemBinding: TodayDealItemBinding) :
